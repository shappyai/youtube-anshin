...
def main():
    ...
    # --- 冒頭: ユーザー提供画像を主役に（y0〜890 に収め、字幕帯と重ねない）---
    ...
    ], None, "intro_visual_v4.png", False, (1582, 890), (169, 0), False, 0.0))
    ...
    ], None, "channel_logo_google.png", False, (409, 230), (755, 110), False, 0.8))
