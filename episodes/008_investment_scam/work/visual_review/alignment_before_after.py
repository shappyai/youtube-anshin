# -*- coding: utf-8 -*-
"""Create the Episode 008 Visual Gate v3 -> v4 alignment comparison."""
...
OUTPUT = BASE / "alignment_before_after.png"
TARGETS = [2, 5, 7, 9, 12, 15, 17]
THUMB_SIZE = (480, 270)
GAP = 18
SIDE = 36
HEADER = 94
...
def main() -> None:
    ...
    draw.text((SIDE, 16), "Episode 008 Visual Gate v3 → v4 整列比較", font=font(28), fill="#173a68")
    draw.text((SIDE, 56), "左: v3 ／ 右: v4（中央軸・section pill・panel整列・チャンネル名削除）", font=font(21), fill="#587187")
    y = HEADER + 24
    for scene_id in TARGETS:
        for directory, x in ((V3_DIR, SIDE), (V4_DIR, SIDE + THUMB_SIZE[0] + GAP)):
