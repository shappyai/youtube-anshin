# Short003 Visual Redesign Draft v4 QA

- duration：28.60秒（目標27〜31秒、最大35秒）
- core scene count：3（冒頭 / 行動 / 結論）
- visual beat count：8（要求6〜8）
- mean meaningful visual change interval：3.57秒（target 2〜4秒）
- static hold >5秒：1
- static hold >7秒：0（FAIL基準0）
- ImageGen-native unique assets：3（v2 reuse、新規call 0）
- renderer-native visual beats：2
...
- draft：shorts/003_mynumber_smartphone/output/draft_v4.mp4
- timeline：shorts/003_mynumber_smartphone/work/render_manifest_v4.json
